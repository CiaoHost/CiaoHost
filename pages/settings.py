        ...
        with st.expander("Twilio SMS", expanded=st.session_state.api_settings["twilio"]["enabled"]):
            ...
            if enabled:
                with st.form("twilio_form"):
                    ...
                    phone_number = st.text_input("Numero di Telefono", value=api_twilio["phone_number"],
                                              help="Numero di telefono Twilio nel formato +123456789")
        ...
        with st.expander("OpenAI", expanded=st.session_state.api_settings["openai"]["enabled"]):
            ...
            if enabled:
                with st.form("openai_form"):
                    ...
                    st.markdown("""
                    **Nota**: Il modello `gpt-4o` è consigliato per le migliori prestazioni ma ha un costo maggiore.
                    `gpt-3.5-turbo` è più economico ma meno accurato nelle risposte.
                    """)
            ...
            with st.spinner("Creazione backup in corso..."):
                ...
                st.download_button(
                    ...
                    data=json.dumps({
                        ...
                        "properties_count": len(st.session_state.properties),
                        "bookings_count": len(st.session_state.bookings)
                    }),
    ...
    with backup_tabs[2]:
        ...
        if st.button("Esporta Dati"):
            with st.spinner("Esportazione in corso..."):
                if export_type == "Immobili" and st.session_state.properties:
                    # Create the export
                ...
                elif export_type == "Prenotazioni" and st.session_state.bookings:
